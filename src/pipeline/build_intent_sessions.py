...
def build_intent_sessions(
    ...
    while current <= end_date:
        ...
        try:
            ...
            # На WSL/Windows-mounted путях Polars sink_parquet иногда падает
            # при открытии output-файла. Дневной chunk помещается в память,
            # поэтому collect+write здесь надежный fallback.
